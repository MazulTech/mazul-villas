...
// Menú principal de Inventario: elige la villa y de ahí entras a su propia
// pantalla (ver InventarioVilla.tsx) donde puedes agregar, ver y descargar
// el reporte sin tener que volver a elegir la villa en cada acción.
export default function Inventario() {
  ...
  return (
    <div>
      ...
      <p className="page-sub">Elige una villa para ver, agregar o descargar su reporte</p>
