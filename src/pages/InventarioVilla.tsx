...
export default function InventarioVilla() {
  ...
  return (
    <div>
      <Link to="/inventario" style={{ fontSize: 12, color: "var(--terra-dark)", display: "inline-block", marginBottom: 12 }}>
        ← Todas las villas
      </Link>

      <h1 className="page-title">{villa ? etiquetaVilla(villa) : "Inventario"}</h1>
      <p className="page-sub">Mobiliario y equipo, con foto</p>

      <div style={{ display: "flex", gap: 8, marginBottom: 14 }}>
        {gestionar && (
          <Link
            to={`/inventario/villa/${villaId}/nuevo`}
